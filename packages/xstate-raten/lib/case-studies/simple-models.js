...
exports.simpleModelsMetadata =
  exports.failoverSystemBSM =
  exports.roverControlBSM =
  exports.parcelRouterBSM =
  exports.contentManagementBSM =
    void 0;
 ...
 */
exports.contentManagementBSM = (0, xstate_1.createMachine)({
 ...
 */
exports.parcelRouterBSM = (0, xstate_1.createMachine)({
  id: "parcelRouter",
  initial: "idle",
  context: {
    parcelId: null,
 ...
 */
exports.roverControlBSM = (0, xstate_1.createMachine)({
  id: "roverControl",
  initial: "powered_off",
  context: {
    batteryLevel: 100,
 ...
 */
exports.failoverSystemBSM = (0, xstate_1.createMachine)({
  id: "failoverSystem",
  initial: "system_off",
  context: {
...
exports.simpleModelsMetadata = {
  CM: {
    ...
    transitionCount: 12,
    loc: 3,
    machine: exports.contentManagementBSM,
  },
  PR: {
    name: "Parcel Router",
    stateCount: 25,
    transitionCount: 29,
    loc: 45,
    machine: exports.parcelRouterBSM,
  },
  RO: {
    name: "Rover Control",
    stateCount: 32,
    transitionCount: 38,
    loc: 75,
    machine: exports.roverControlBSM,
  },
  FO: {
    ...
    transitionCount: 53,
    loc: 164,
    machine: exports.failoverSystemBSM,
  },
};
