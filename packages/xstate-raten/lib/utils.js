...
exports.getBadStates = exports.getGoodStates = exports.compareStates = exports.isMatched = exports.resolveStatePath = exports.getStateNode = exports.isBadState = exports.isGoodState = void 0;
/**
...
function isGoodState(state, machine, goodStateTags) {
    ...
    try {
        // Check tags
        for (var goodStateTags_1 = __values(goodStateTags), goodStateTags_1_1 = goodStateTags_1.next(); !goodStateTags_1_1.done; goodStateTags_1_1 = goodStateTags_1.next()) {
            var tag = goodStateTags_1_1.value;
            if (stateNode.tags.has(tag)) {
                return true;
            }
        }
    }
        ...
        try {
            if (goodStateTags_1_1 && !goodStateTags_1_1.done && (_a = goodStateTags_1.return)) _a.call(goodStateTags_1);
        }
        finally { if (e_1) throw e_1.error; }
    }
    // Fallback: check if state name contains "Good"
    var stateStr = typeof state === 'string' ? state : JSON.stringify(state);
    return stateStr.toLowerCase().includes('good');
}
...
function isBadState(state, machine, badStateTags) {
    ...
    try {
        // Check tags
        for (var badStateTags_1 = __values(badStateTags), badStateTags_1_1 = badStateTags_1.next(); !badStateTags_1_1.done; badStateTags_1_1 = badStateTags_1.next()) {
        ...
        try {
            if (badStateTags_1_1 && !badStateTags_1_1.done && (_a = badStateTags_1.return)) _a.call(badStateTags_1);
        }
        finally { if (e_2) throw e_2.error; }
    }
    // Fallback: check if state name contains "Bad"
    var stateStr = typeof state === 'string' ? state : JSON.stringify(state);
    return stateStr.toLowerCase().includes('bad');
}
    ...
    function traverse(obj, prefix) {
        ...
        for (var key in obj) {
            if (typeof obj[key] === 'string') {
                parts.push(prefix ? "".concat(prefix, ".").concat(key, ".").concat(obj[key]) : "".concat(key, ".").concat(obj[key]));
            }
...
function getGoodStates(machine, goodStateTags) {
    ...
    function traverse(node) {
        var e_3, _a;
        if (isGoodState(node.id, machine, goodStateTags)) {
            goodStates.push(node.id);
        }
        ...
        try {
            ...
            try {
                if (stateValues_1_1 && !stateValues_1_1.done && (_a = stateValues_1.return)) _a.call(stateValues_1);
            }
...
function getBadStates(machine, badStateTags) {
    ...
    function traverse(node) {
        var e_4, _a;
        if (isBadState(node.id, machine, badStateTags)) {
            badStates.push(node.id);
        }
        var stateValues = Object.keys(node.states).map(function (key) { return node.states[key]; });
        try {
            for (var stateValues_2 = __values(stateValues), stateValues_2_1 = stateValues_2.next(); !stateValues_2_1.done; stateValues_2_1 = stateValues_2.next()) {
            ...
            try {
                if (stateValues_2_1 && !stateValues_2_1.done && (_a = stateValues_2.return)) _a.call(stateValues_2);
            }
