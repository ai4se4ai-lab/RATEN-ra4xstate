  ...
  var hasNonLastUnguardedTarget = transitions
    ...
    .some(function (transition) {
      return (
        !("cond" in transition) &&
        !("in" in transition) &&
        ((0, utils_1.isString)(transition.target) ||
          (0, utils_1.isMachine)(transition.target))
      );
    });
  var eventText =
...
var StateNode = /** @class */ (function () {
  function StateNode(
    ...
    this.states = this.config.states
      ? (0, utils_1.mapValues)(this.config.states, function (stateConfig, key) {
          var _a;
    ...
    function dfs(stateNode) {
      ...
      try {
        for (
          var _b = __values((0, stateUtils_1.getAllChildren)(stateNode)),
            _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
    ...
    this.onEntry = (0, utils_1.toArray)(
      this.config.entry || this.config.onEntry
    ).map(function (action) {
      return (0, actions_1.toActionObject)(action);
    });
    // TODO: deprecate (exit)
    this.onExit = (0, utils_1.toArray)(
    ...
    this.invoke = (0, utils_1.toArray)(this.config.invoke).map(function (
      invokeConfig,
      i
    ) {
      var _a, _b;
      if ((0, utils_1.isMachine)(invokeConfig)) {
        var invokeId = (0, utils_1.createInvokeId)(_this.id, i);
        _this.machine.options.services = __assign(
          ((_a = {}), (_a[invokeId] = invokeConfig), _a),
          _this.machine.options.services
        );
        return (0, invokeUtils_1.toInvokeDefinition)({
          src: invokeId,
          id: invokeId,
        });
      } else if ((0, utils_1.isString)(invokeConfig.src)) {
        var invokeId =
          invokeConfig.id || (0, utils_1.createInvokeId)(_this.id, i);
        return (0, invokeUtils_1.toInvokeDefinition)(
        ...
        (0, utils_1.isMachine)(invokeConfig.src) ||
        (0, utils_1.isFunction)(invokeConfig.src)
      ) {
        var invokeId =
          invokeConfig.id || (0, utils_1.createInvokeId)(_this.id, i);
        _this.machine.options.services = __assign(
        ...
        return (0, invokeUtils_1.toInvokeDefinition)(
          __assign(__assign({ id: invokeId }, invokeConfig), { src: invokeId })
        );
      } else {
        ...
        return (0, invokeUtils_1.toInvokeDefinition)(
          __assign(
            __assign(
              { id: (0, utils_1.createInvokeId)(_this.id, i) },
              invokeConfig
            ),
            { src: invokeSource }
          )
    ...
    this.activities = (0, utils_1.toArray)(this.config.activities)
      .concat(this.invoke)
      .map(function (activity) {
        return (0, actions_1.toActivityDefinition)(activity);
      });
    this.transition = this.transition.bind(this);
    this.tags = (0, utils_1.toArray)(this.config.tags);
  ...
  StateNode.prototype._init = function () {
    ...
    (0, stateUtils_1.getAllStateNodes)(this).forEach(function (stateNode) {
      return stateNode.on;
    });
  };
  /**
  ...
  Object.defineProperty(StateNode.prototype, "context", {
    get: function () {
      return (0, utils_1.isFunction)(this._context)
        ? this._context()
        : this._context;
    },
    enumerable: false,
  ...
  Object.defineProperty(StateNode.prototype, "definition", {
    ...
    get: function () {
      return {
        ...
        states: (0, utils_1.mapValues)(this.states, function (state) {
  ...
  StateNode.prototype.getDelayedTransitions = function () {
    ...
    var mutateEntryExit = function (delay, i) {
      var delayRef = (0, utils_1.isFunction)(delay)
        ? "".concat(_this.id, ":delay[").concat(i, "]")
        : delay;
      var eventType = (0, actions_1.after)(delayRef, _this.id);
      _this.onEntry.push((0, actions_1.send)(eventType, { delay: delay }));
      _this.onExit.push((0, actions_1.cancel)(eventType));
      return eventType;
    };
    var delayedTransitions = (0, utils_1.isArray)(afterConfig)
      ...
      : (0, utils_1.flatten)(
          Object.keys(afterConfig).map(function (delay, i) {
            ...
            var resolvedTransition = (0, utils_1.isString)(configTransition)
              ? { target: configTransition }
              : configTransition;
            var resolvedDelay = !isNaN(+delay) ? +delay : delay;
            var eventType = mutateEntryExit(resolvedDelay, i);
            return (0, utils_1.toArray)(resolvedTransition).map(function (
              transition
            ) {
  ...
  StateNode.prototype.getStateNodes = function (state) {
    ...
    var stateValue =
      state instanceof State_1.State
        ? state.value
        : (0, utils_1.toStateValue)(state, this.delimiter);
    if ((0, utils_1.isString)(stateValue)) {
  ...
  StateNode.prototype.handles = function (event) {
    var eventType = (0, utils_1.getEventType)(event);
  ...
  StateNode.prototype.resolveState = function (state) {
    var stateFromConfig =
      state instanceof State_1.State ? state : State_1.State.create(state);
    var configuration = Array.from(
      (0, stateUtils_1.getConfiguration)(
        [],
    ...
    return new State_1.State(
      __assign(__assign({}, stateFromConfig), {
        ...
        done: (0, stateUtils_1.isInFinalState)(configuration, this),
        tags: (0, stateUtils_1.getTagsFromConfiguration)(configuration),
  ...
  StateNode.prototype.transitionParallelNode = function (
    ...
    var enabledTransitions = (0, utils_1.flatten)(
    ...
    var entryNodes = (0, utils_1.flatten)(
      stateTransitions.map(function (t) {
        return t.entrySet;
      })
    );
    var configuration = (0, utils_1.flatten)(
  ...
  StateNode.prototype.next = function (state, _event) {
    ...
    try {
      for (
        ...
        var isInState = stateIn
          ? (0, utils_1.isString)(stateIn) && isStateId(stateIn)
            ? // Check if in state by ID
              state.matches(
                (0, utils_1.toStateValue)(
                  this.getStateNodeById(stateIn).path,
                  this.delimiter
                )
              )
            : // Check if in state by relative grandparent
              (0, utils_2.matchesState)(
                (0, utils_1.toStateValue)(stateIn, this.delimiter),
                (0, utils_1.path)(this.path.slice(0, -2))(state.value)
              )
          : true;
    ...
    var allNextStateNodes = (0, utils_1.flatten)(
    ...
    if (!isInternal) {
      nextStateNodes.forEach(function (targetNode) {
        reentryNodes.push.apply(
          reentryNodes,
          __spreadArray(
            [],
            __read(_this.getExternalReentryNodes(targetNode)),
            false
          )
        );
      });
  ...
  StateNode.prototype.getActions = function (
    ...
    var e_4, _a, e_5, _b;
    var _this = this;
    var prevConfig = (0, stateUtils_1.getConfiguration)(
      [],
    ...
    try {
      for (
        ...
        if (
          !(0, stateUtils_1.has)(prevConfig, sn) ||
          ((0, stateUtils_1.has)(transition.entrySet, sn.parent) &&
            !(0, stateUtils_1.has)(transition.entrySet, sn))
        ) {
    ...
    try {
      for (
        ...
        if (
          !(0, stateUtils_1.has)(resolvedConfig, sn) ||
          (0, stateUtils_1.has)(transition.exitSet, sn.parent)
        ) {
    ...
    var doneEvents = (0, utils_1.flatten)(
      transition.entrySet.map(function (sn) {
        ...
        events.push(
          (0, actions_1.done)(sn.id, sn.doneData), // TODO: deprecate - final states should not emit done events for their own state.
          (0, actions_1.done)(
            parent.id,
            sn.doneData
              ? (0, utils_1.mapContext)(sn.doneData, currentContext, _event)
              : undefined
          )
        );
        ...
        if (grandparent.type === "parallel") {
          if (
            (0, stateUtils_1.getChildren)(grandparent).every(function (
              parentNode
            ) {
              return (0, stateUtils_1.isInFinalState)(
                transition.configuration,
                parentNode
              );
            })
          ) {
            events.push((0, actions_1.done)(grandparent.id));
          }
        }
        return events;
      })
    ...
    var entryActions = Array.from(entryStates)
      .map(function (stateNode) {
        var entryActions = stateNode.onEntry;
        var invokeActions = stateNode.activities.map(function (activity) {
          return (0, actions_1.start)(activity);
        });
        return (0,
        actions_1.toActionObjects)(predictableExec ? __spreadArray(__spreadArray([], __read(entryActions), false), __read(invokeActions), false) : __spreadArray(__spreadArray([], __read(invokeActions), false), __read(entryActions), false), _this.machine.options.actions);
      })
      .concat([doneEvents.map(actions_1.raise)]);
    var exitActions = Array.from(exitStates).map(function (stateNode) {
      return (0, actions_1.toActionObjects)(
        __spreadArray(
          __spreadArray([], __read(stateNode.onExit), false),
          __read(
            stateNode.activities.map(function (activity) {
              return (0, actions_1.stop)(activity);
            })
          ),
          false
        ),
    ...
    var actions = exitActions
      ...
      .concat(entryActions);
    if (isDone) {
      var stopActions = (0, actions_1.toActionObjects)(
        (0, utils_1.flatten)(
          __spreadArray([], __read(resolvedConfig), false)
            .sort(function (a, b) {
              return b.order - a.order;
            })
            .map(function (stateNode) {
        ...
        return (
          ...
          (action.type !== actionTypes.send ||
            (!!action.to && action.to !== types_1.SpecialTargets.Internal))
        );
      });
  ...
  StateNode.prototype.transition = function (state, event, context, exec) {
    ...
    var _event = (0, utils_1.toSCXMLEvent)(event);
    var currentState;
    if (state instanceof State_1.State) {
      ...
      var resolvedStateValue = (0, utils_1.isString)(state)
        ? this.resolve(
            (0, utils_1.pathToStateValue)(this.getResolvedPath(state))
          )
        : this.resolve(state);
      var resolvedContext =
    ...
    if (this.strict) {
      if (
        ...
        !(0, utils_1.isBuiltInEvent)(_event.name)
      ) {
        throw new Error(
          "Machine '"
  ...
  StateNode.prototype.resolveTransition = function (
    ...
    var resolvedConfiguration = willTransition
      ...
      : [];
    var isDone = (0, stateUtils_1.isInFinalState)(resolvedConfiguration, this);
    var resolvedStateValue = willTransition
      ? (0, stateUtils_1.getValue)(this.machine, configuration)
      : undefined;
    var historyValue = currentState
      ? currentState.historyValue
        ...
        : undefined
      : undefined;
    var actionBlocks = this.getActions(
    ...
    try {
      for (
        ...
        try {
          for (
            var block_1 = ((e_7 = void 0), __values(block)),
    ...
    var _c = __read(
      ...
      updatedContext = _c[1];
    var _d = __read(
        (0, utils_1.partition)(resolvedActions, function (action) {
          return (
            action.type === actionTypes.raise ||
            (action.type === actionTypes.send &&
    ...
    var invokeActions = resolvedActions.filter(function (action) {
      ...
      return (
        ...
        ((_a = action.activity) === null || _a === void 0
          ? void 0
          : _a.type) === actionTypes.invoke
      );
    });
    var children = invokeActions.reduce(
      function (acc, action) {
        acc[action.activity.id] = (0, Actor_1.createInvocableActor)(
          action.activity,
          _this.machine,
          updatedContext,
          _event
    ...
    var nextState = new State_1.State({
      ...
      historyValue: resolvedStateValue
        ? historyValue
          ? (0, utils_1.updateHistoryValue)(historyValue, resolvedStateValue)
          : undefined
        : currentState
        ? currentState.historyValue
        : undefined,
      ...
      tags: (0, stateUtils_1.getTagsFromConfiguration)(resolvedConfiguration),
      machine: this,
    });
    ...
    var changed =
      ...
      (history
        ? !!maybeNextState.actions.length ||
          ...
          !(0, State_1.stateValuesEqual)(maybeNextState.value, history.value)
        : undefined);
  ...
  StateNode.prototype.getStateNodeByPath = function (statePath) {
    ...
    var arrayStatePath = (0, utils_1.toStatePath)(
      statePath,
      this.delimiter
    ).slice();
  ...
  StateNode.prototype.getResolvedPath = function (stateIdentifier) {
    ...
    return (0, utils_1.toStatePath)(stateIdentifier, this.delimiter);
  };
  Object.defineProperty(StateNode.prototype, "initialStateValue", {
    get: function () {
      ...
      if (this.type === "parallel") {
        initialStateValue = (0, utils_1.mapFilterValues)(
          this.states,
          function (state) {
        ...
        initialStateValue = (0, stateUtils_1.isLeafNode)(
  ...
  Object.defineProperty(StateNode.prototype, "target", {
    ...
    get: function () {
      ...
      if (this.type === "history") {
        ...
        if ((0, utils_1.isString)(historyConfig.target)) {
          target = isStateId(historyConfig.target)
            ? (0, utils_1.pathToStateValue)(
                this.machine
  ...
  Object.defineProperty(StateNode.prototype, "initialStateNodes", {
    get: function () {
      var _this = this;
      if ((0, stateUtils_1.isLeafNode)(this)) {
        return [this];
      }
      ...
      var initialStateNodePaths = (0, utils_1.toStatePaths)(
        this.initialStateValue
      );
      return (0, utils_1.flatten)(
  ...
  StateNode.prototype.historyValue = function (relativeStateValue) {
    ...
    return {
      ...
      states: (0, utils_1.mapFilterValues)(
        this.states,
        function (stateNode, key) {
          if (!relativeStateValue) {
            return stateNode.historyValue();
          }
          var subStateValue = (0, utils_1.isString)(relativeStateValue)
            ? undefined
  ...
  StateNode.prototype.resolveHistory = function (historyValue) {
    ...
    if (!historyValue) {
      ...
      return historyTarget
        ? (0, utils_1.flatten)(
            (0, utils_1.toStatePaths)(historyTarget).map(function (
              relativeChildPath
            ) {
    ...
    var subHistoryValue = (0, utils_1.nestedPath)(
      parent.path,
      "states"
    )(historyValue).current;
    if ((0, utils_1.isString)(subHistoryValue)) {
      return [parent.getStateNode(subHistoryValue)];
    }
    return (0, utils_1.flatten)(
      (0, utils_1.toStatePaths)(subHistoryValue).map(function (subStatePath) {
  ...
  Object.defineProperty(StateNode.prototype, "stateIds", {
    ...
    get: function () {
      var _this = this;
      var childStateIds = (0, utils_1.flatten)(
  ...
  Object.defineProperty(StateNode.prototype, "events", {
    ...
    get: function () {
      ...
      if (states) {
        try {
          for (
            var _c = __values(Object.keys(states)), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
            ...
            if (state.states) {
              try {
                for (
                  var _e = ((e_9 = void 0), __values(state.events)),
                    _f = _e.next();
                  !_f.done;
                  _f = _e.next()
                ) {
  ...
  StateNode.prototype.formatTransition = function (transitionConfig) {
    var _this = this;
    var normalizedTarget = (0, utils_1.normalizeTarget)(
    ...
    var internal =
      "internal" in transitionConfig
        ...
        ? normalizedTarget.some(function (_target) {
            return (
              (0, utils_1.isString)(_target) && _target[0] === _this.delimiter
            );
          })
        : true;
    ...
    var transition = __assign(__assign({}, transitionConfig), {
      actions: (0, actions_1.toActionObjects)(
        (0, utils_1.toArray)(transitionConfig.actions)
      ),
      cond: (0, utils_1.toGuard)(transitionConfig.cond, guards),
      target: target,
      source: this,
      internal: internal,
  ...
  StateNode.prototype.formatTransitions = function () {
      ...
      onConfig = (0, utils_1.flatten)(
        Object.keys(strictTransitionConfigs_1)
          .map(function (key) {
            ...
            var transitionConfigArray = (0, utils_1.toTransitionConfigArray)(
              key,
          ...
          .concat(
            (0, utils_1.toTransitionConfigArray)(WILDCARD, wildcardConfigs)
          )
      );
    }
    var eventlessConfig = this.config.always
      ? (0, utils_1.toTransitionConfigArray)("", this.config.always)
      : [];
    var doneConfig = this.config.onDone
      ? (0, utils_1.toTransitionConfigArray)(
          String((0, actions_1.done)(this.id)),
          this.config.onDone
        )
      : [];
    if (!environment_1.IS_PRODUCTION) {
    ...
    var invokeConfig = (0, utils_1.flatten)(
        ...
        if (invokeDef.onDone) {
          settleTransitions.push.apply(
            ...
            __spreadArray(
              ...
              __read(
                (0, utils_1.toTransitionConfigArray)(
                  String((0, actions_1.doneInvoke)(invokeDef.id)),
                  invokeDef.onDone
                )
              ),
              false
        ...
        if (invokeDef.onError) {
          settleTransitions.push.apply(
            ...
            __spreadArray(
              ...
              __read(
                (0, utils_1.toTransitionConfigArray)(
                  String((0, actions_1.error)(invokeDef.id)),
                  invokeDef.onError
                )
              ),
              false
    ...
    var formattedTransitions = (0, utils_1.flatten)(
      __spreadArray(
        __spreadArray(
          __spreadArray(
        ...
        return (0, utils_1.toArray)(transitionConfig).map(function (
          transition
        ) {
