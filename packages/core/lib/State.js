...
exports.State =
  exports.bindActionToState =
  exports.isState =
  exports.isStateConfig =
  exports.stateValuesEqual =
    void 0;
...
var State = /** @class */ (function () {
  ...
  function State(config) {
    ...
    this.meta = (0, stateUtils_1.getMeta)(config.configuration);
    ...
    this.tags =
      (_a = Array.isArray(config.tags) ? new Set(config.tags) : config.tags) !==
        null && _a !== void 0
        ? _a
        : new Set();
    ...
    Object.defineProperty(this, "nextEvents", {
      get: function () {
        return (0, stateUtils_1.nextEvents)(_this.configuration);
      },
    });
  }
  /**
  ...
  State.prototype.matches = function (parentStateValue) {
    return (0, utils_1.matchesState)(parentStateValue, this.value);
  };
  /**
  ...
  State.prototype.can = function (event) {
    ...
    var transitionData =
      (_a = this.machine) === null || _a === void 0
        ? void 0
        : _a.getTransitionData(this, event);
    return (
