...
exports.getTagsFromConfiguration =
  exports.getMeta =
...
function getAllStateNodes(stateNode) {
  ...
  if ((0, exports.isLeafNode)(stateNode)) {
    return stateNodes;
  }
  return stateNodes.concat(
    (0, utils_1.flatten)(getChildren(stateNode).map(getAllStateNodes))
  );
}
...
function getValueFromAdj(baseNode, adjList) {
  ...
  if (baseNode.type === "compound") {
    ...
    if (childStateNode) {
      if ((0, exports.isLeafNode)(childStateNode)) {
