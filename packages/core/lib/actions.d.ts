...
export declare const toActionObjects: <TContext, TEvent extends EventObject>(
  ...
  actionFunctionMap?:
    | ActionFunctionMap<TContext, TEvent, import("./types").BaseActionObject>
    | undefined
) => ActionObject<TContext, TEvent>[];
...
export declare function resolveStop<TContext, TEvent extends EventObject>(
